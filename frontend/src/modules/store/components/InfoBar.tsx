...
export default function InfoBar() {
	...
	return (
		<nav className="flex w-full items-center dark:bg-black">
			<ul className="flex gap-10 mr-auto items-baseline">
				<li className="bg-sky-600 dark:outline dark:outline-2 dark:outline-white">
					<NavLink
						aria-current="page"
						to={'/store'}
						className={'flex gap-2 bg-sky-700 text-white rounded-md p-3'}
					>
						<Store /> Store
					</NavLink>
				</li>
